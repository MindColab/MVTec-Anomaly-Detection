...
'''
# habilitar la ejecución acelerada
tf.compat.v1.enable_eager_execution()

# habilitar el crecimiento automático de memoria de GPU
...
def main(args):
    ...
    # get autoencoder
    autoencoder = AutoEncoder(input_dir, architecture, color_mode, loss, batch_size, initial_weights_path=initial_weights_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        metavar="",
        default="None",
        help="path to model file initial weights",
    )
